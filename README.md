...
### 3. Layer 2 — SYM (Символы, мувер hjkl и прочее)
...
- Верхний и правый ряды содержат популярные символы (`~ ! @ # $ % ^ & * ( ) _ + =` и др.) максимально приближенной к компоновке классической клавиатуры
- Дублирует клавиши `H J K L` для перемещения курсора (удобно, когда Home Row Mods мешают)
- Есть режим вкл. caps_word (включение caps на одно слово)
- Нижний ряд — различные макросы
...
### 6. Layer 5 — UN_SYM (символы через unicode последовательности)
